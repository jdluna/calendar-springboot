...
public class CalendarController {
	...
	// this map is used to store "JAN" -> 6 rows with 7 columns - empty spaces for days not of this month
	...
	/**
	 * Builds array list of date objects from parameters and
	 * adds it to the hashmap by month name string. 
	 * 
